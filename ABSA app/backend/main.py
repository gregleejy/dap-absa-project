...
async def analyze_text(input: TextInput):
    try:
        ...
        word_pieces, predictions_abte, predictions_absa, abte_outputs, absa_outputs = modelABSA_MTL.predict(sentence=input.text, load_model=model_path, tokenizer=tokenizer, device=DEVICE)
